...
#define __SIMLIB__        0x0307 // version of SIMLIB (numerical)
#define SIMLIB_VERSION    "3.07" // version of SIMLIB (string)

#define SIMLIB_COPYRIGHT  "(c) Petr Peringer, 1991-2018"
// -------------------------------------------------------------------------
